...
public record AlbumContentHierarchical
{
    ...
    public string InnerFeatureItemType { get; set; } = string.Empty; 
    public string InnerFeatureItemPath { get; set; } = string.Empty; 
    ...
    public static AlbumContentHierarchical CreateFromDataReader(DbDataReader reader)
    {
        return new AlbumContentHierarchical
        {
            ...
            FeatureItemType = reader.GetString(reader.GetOrdinal("feature_item_type")),
            FeatureItemPath = reader.GetString(reader.GetOrdinal("feature_item_path")),
            InnerFeatureItemType = reader.GetString(reader.GetOrdinal("inner_feature_item_type")),
            InnerFeatureItemPath = reader.GetString(reader.GetOrdinal("inner_feature_item_path")),
