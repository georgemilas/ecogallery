...
public class FileObserverService : FilePeriodicScanService
{
    ...
    public FileObserverService(IFileProcessor processor, int intervalMinutes = 2)
    ...
    {
        Console.WriteLine($"Starting FileObserverService on folder: {_processor.RootFolder.FullName}");
